...
WORKDIR /src
COPY ["DotnetFunction.csproj", "DotnetFunction/"]
RUN dotnet restore "DotnetFunction/DotnetFunction.csproj"

WORKDIR "/src/DotnetFunction"
COPY . .
RUN dotnet build "DotnetFunction.csproj" --configuration Release --output /app/build
...
Execute unit tests
```
cd "DotnetFunction/test/DotnetFunction.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "DotnetFunction/src/DotnetFunction"
