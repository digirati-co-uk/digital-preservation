...
<!--PATTERN struct-links-->
	...
	<!--RULE -->
<axsl:template match="mets:structLink/mets:smLink" priority="1000" mode="M4"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="mets:structLink/mets:smLink"/>
